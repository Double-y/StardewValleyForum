...
SECRET_KEY = 'django-insecure-eiae-!z_9@ylh=fpwa7t5v0p5b1b#x4g)300%#=^fklc3=8*g9'
...
# session settings
SESSION_COOKIE_AGE = 60 * 60 * 24 * 3                           # session过期时间，单位秒，此处设为3天
SESSION_SAVE_EVERY_REQUEST = True                               # 每次请求都保存session，默认False
SESSION_EXPIRE_AT_BROWSER_CLOSE = True                          # 浏览器关闭则session过期，默认False